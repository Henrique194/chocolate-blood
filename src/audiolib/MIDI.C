...
static unsigned int _MIDI_Time;
...
static unsigned int _MIDI_TotalTime;
...
int MIDI_Reset
   ...
   TS_InterruptDisabled = 1;
   SDL_Delay(1000 / 24);
   TS_InterruptDisabled = 0;
...
int MIDI_PlaySong
   ...
   _MIDI_PlayRoutine = TS_ScheduleTask( _MIDI_ServiceRoutine, 100, 1, NULL, TASK_CHANNEL_MUSIC );
